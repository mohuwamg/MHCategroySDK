...
typedef NS_ENUM(NSInteger, WYButtonImgViewStyle) {
    WYButtonImgViewStyleTop, //image上，title下
    WYButtonImgViewStyleLeft, // image左 title右
    WYButtonImgViewStyleBottom, // image下,title上
    WYButtonImgViewStyleRight, // image右,title左
};

@interface UIButton (LFExtensions)
 ...
 */
- (void)setImgViewStyle:(WYButtonImgViewStyle)style imageSize:(CGSize)size space:(CGFloat)space;
